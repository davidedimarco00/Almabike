  ...
  <div class="dashboard-selector mt-2 mb-2 mx-4">
      <div class="row  align-items-center">
        <div class="col-6 d-flex  align-items-center">
          <button type="button" id="dashboardBtn" class="btn selectorbtn btn-light btn-outline-light btn-block text-dark">Dashboard</button>
        </div>
        <div class="col-6 d-flex  align-items-center">
          <button type="button" id="myRouteBtn" class="btn selectorbtn btn-light btn-outline-light btn-block text-dark">I miei percorsi</button>
        </div>
      </div>
    </div>