<div class="mycontainer-private">
  ...
  <small text="muted">Questa è la tua area riservata. In questa pagina puoi visualizzare i dati di tuo
    interesse.</small>
  <div class="container-description">

    <h4 class="alert-heading">Ciao
      <?php echo $_SESSION['Nome'] ?>, la tua bici è equipaggiata con il sensore
    ...
    <h6>Qui puoi ricercare le parole chiave nei tuoi percorsi <span><i class="fa fa-info-circle custom-tooltip"
          title="Clicca su una riga della tabella per visualizare il percorso sulla mappa"
